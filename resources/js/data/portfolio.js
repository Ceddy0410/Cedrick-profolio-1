export const profile = {
    name: 'Cedrick Opina',
    title: 'Website Developer & Quality Assurance Specialist',
    location: 'Quezon City, Philippines',
    email: 'opinacedrickr@gmail.com',
...
export const capabilities = [
    {
        number: '01',
        label: 'Build',
        title: 'Web experiences made for real people.',
        description: 'Responsive WordPress, Elementor, Laravel, and React experiences shaped around business goals and everyday users.',
        tags: ['Laravel', 'React', 'WordPress'],
    },
    {
        number: '02',
        label: 'Test',
        title: 'Quality built into every interaction.',
        description: 'Manual and automated mobile and web testing across functionality, usability, responsiveness, and regression coverage.',
        tags: ['Maestro', 'Playwright', 'UI/UX QA'],
    },
    {
        number: '03',
        label: 'Grow',
        title: 'Improvements people can find and feel.',
        description: 'Technical SEO, Semrush-led audits, frontend troubleshooting, and practical recommendations that improve digital products.',
        tags: ['Semrush', 'Technical SEO', 'Support'],
    },
];
